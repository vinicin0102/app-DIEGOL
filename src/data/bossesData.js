...
const BOSSES_DESAFIO = [
  {
    ...
    description: 'Quanto mais você fica parado, mais forte ele fica. Ele transforma seu sofá em uma prisão e sua cadeira em correntes.',
  ...
  },
  {
    ...
    title: 'O Monstro do "Deixa Pra Amanhã"',
    description: 'Uma besta ancestral que sussurra: "deixa pra amanhã…" Cada dia adiado duplica seu poder.',
  ...
  },
  {
    ...
    key: 'preguicor',
    name: 'Preguiçor',
    title: 'O Devorador de Energia',
    description: 'Uma criatura gigante que drena sua energia antes mesmo de você começar. Ele é a razão pela qual você "não tá com vontade".',
  ...
  },
  {
    ...
    description: 'Ele te prende no sofá e rouba sua disciplina. Seu campo de força hipnótico te faz assistir "só mais um episódio".',
  ...
  },
  {
    ...
    key: 'desculpator',
    name: 'Desculpator',
    title: 'O Mestre das Desculpas',
    description: 'Mestre do "tô cansado", "amanhã eu vou", "segunda eu começo". Ele tem uma desculpa pra cada situação.',
  ...
  },
  {
    ...
    description: 'Seu objetivo é te manter parado para sempre. Ele comanda um exército de hábitos ruins que te cercam de todos os lados.',
  ...
  },
  {
    ...
    description: 'Governa o reino do "depois eu faço". Seu cetro congela o tempo e faz você perder dias inteiros sem perceber.',
  ...
  },
  {
    ...
    key: 'preguicovski',
    name: 'Preguiçovski',
    title: 'O Vilão Calculista',
    description: 'Um vilão frio e calculista que destrói sua motivação lentamente. Cada gota de seu veneno congela uma parte da sua disciplina.',
  ...
  },
  {
    ...
    key: 'lorde_inercius',
    name: 'Lorde Inércius',
    title: 'O Senhor da Inércia',
    description: 'Ele controla a força que te impede de sair do lugar. Sua gravidade é tão forte que até seus pensamentos ficam pesados.',
  ...
  },
  {
    ...
    key: 'sombracansaco',
    name: 'Sombracansaço',
    title: 'A Entidade do Cansaço Fantasma',
    description: 'Ela faz você se sentir cansado mesmo quando não fez nada. Seu poder é tão sombrio que drena sua energia só de existir.',
